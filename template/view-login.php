...
<div class="var_1">
<input type="phone" value="<?=(empty($_POST))?"":$_POST['numer'];?>" name="numer" placeholder="10 dígitos" maxlength="10">
</div>
<div class="var_1">
<input type="password" name="password" placeholder="contraseña" value="<?=(empty($_POST))?"":$_POST['password'];?>">
</div>
<div class="var_2">
...
<div class="var_1">
<input type="phone" placeholder="número celular" maxlength="10" name="phone" value="<?=isset($_POST["phone"])? $_POST['phone']:'';?>">
</div>
<div class="var_1">
<input type="password" name="passpic" placeholder="contraseña" value="<?=isset($_POST['passpic'])?$_POST["passpic"]:'';?>">
</div>
<div class="var_2">
